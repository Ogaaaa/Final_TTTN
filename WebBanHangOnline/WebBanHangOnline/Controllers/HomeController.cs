...
namespace WebBanHangOnline.Controllers
{
    public class HomeController : Controller
    {
        ...
        public ActionResult Search(string query)
        {
            ...
            {
                return View("ProductList", new List<Product>()); // Trả về danh sách trống nếu không có từ khóa
            }
            ...
            return PartialView("_ProductList", products); // Trả về partial view với danh sách sản phẩm
        }
    }
}